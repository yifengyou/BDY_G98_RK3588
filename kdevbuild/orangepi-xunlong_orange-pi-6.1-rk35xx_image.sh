...
export BUILD_TAG="BDY_G98_orange-pi-6.1-rk35xx_${set_rootfs}"
...
mkdir -p orangepi-xunlong_orange-pi-6.1-rk35xx
cd orangepi-xunlong_orange-pi-6.1-rk35xx

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/config-6.1-kdev
ls -alh config-6.1-kdev
md5sum config-6.1-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/System.map-6.1-kdev
ls -alh System.map-6.1-kdev
md5sum System.map-6.1-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/rk3588-bdy-g98.dtb
ls -alh rk3588-bdy-g98.dtb
md5sum rk3588-bdy-g98.dtb

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
