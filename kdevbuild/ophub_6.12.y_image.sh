...
export BUILD_TAG="BDY_G98_6.12.y_${set_rootfs}"
...
mkdir -p ophub_6.12.y
cd ophub_6.12.y

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.12.y_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.12.y_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.12.y_kernel/config-6.12.y-kdev
ls -alh config-6.12.y-kdev
md5sum config-6.12.y-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.12.y_kernel/System.map-6.12.y-kdev
ls -alh System.map-6.12.y-kdev
md5sum System.map-6.12.y-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.12.y_kernel/rk3588-bdy-g98.dtb
ls -alh rk3588-bdy-g98.dtb
md5sum rk3588-bdy-g98.dtb

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.12.y_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
...
cp -f Image /mnt/vmlinuz-6.12.y-kdev
cp -f config-6.12.y-kdev /mnt/config-6.12.y-kdev
cp -f System.map-6.12.y-kdev /mnt/System.map-6.12.y-kdev
...
label l0
	menu label Linux kernel 6.12.y-kdev
	linux vmlinuz-6.12.y-kdev
	initrd initrd.img-6.12.y-kdev
	fdt /dtb/rk3588-bdy-g98.dtb
	append root=/dev/sda2 rw console=ttyS2,1500000 console=tty1 cgroup_enable=cpuset cgroup_memory=1 cgroup_enable=memory net.ifnames=0 biosdevname=0 level=10 loglevel=10 selinux=0 crashkernel=384M-:128M systemd.mask=systemd-growfs@-.service rockchip.dmc_freq=528000 video=HDMI-A-1:1920x1080@60

label l0r
	menu label Linux kernel 6.12.y-kdev (rescue target)
	linux vmlinuz-6.12.y-kdev
	initrd initrd.img-6.12.y-kdev
	fdt /dtb/rk3588-bdy-g98.dtb
