...
export BUILD_TAG="BDY_G98_lbc-develop-6.1_${set_rootfs}"
...
mkdir -p lubancat_lbc-develop-6.1
cd lubancat_lbc-develop-6.1

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/lubancat_lbc-develop-6.1_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/lubancat_lbc-develop-6.1_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/lubancat_lbc-develop-6.1_kernel/config-6.1-kdev
ls -alh config-6.1-kdev
md5sum config-6.1-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/lubancat_lbc-develop-6.1_kernel/System.map-6.1-kdev
ls -alh System.map-6.1-kdev
md5sum System.map-6.1-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/lubancat_lbc-develop-6.1_kernel/rk3588-bdy-g98.dtb
ls -alh rk3588-bdy-g98.dtb
md5sum rk3588-bdy-g98.dtb

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/lubancat_lbc-develop-6.1_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
...
label l0
	menu label Linux kernel lbc-develop-6.1-kdev
...
label l0r
	menu label Linux kernel lbc-develop-6.1-kdev (rescue target)
	linux vmlinuz-6.1-kdev
	initrd initrd.img-6.1-kdev
	fdt /dtb/rk3588-bdy-g98.dtb
