...
export BUILD_TAG="BDY_G98_linux-6.1.y-rockchip_${set_rootfs}"
...
mkdir -p ophub_linux-6.1.y-rockchip
cd ophub_linux-6.1.y-rockchip

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/Image-linux-6.1.y-rockchip-kdev
ls -alh Image-linux-6.1.y-rockchip-kdev
md5sum Image-linux-6.1.y-rockchip-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/config-linux-6.1.y-rockchip-kdev
ls -alh config-linux-6.1.y-rockchip-kdev
md5sum config-linux-6.1.y-rockchip-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/System.map-linux-6.1.y-rockchip-kdev
ls -alh System.map-linux-6.1.y-rockchip-kdev
md5sum System.map-linux-6.1.y-rockchip-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/rk3588-bdy-g98.dtb
ls -alh rk3588-bdy-g98.dtb
md5sum rk3588-bdy-g98.dtb

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/kos-linux-6.1.y-rockchip.tar.gz
ls -alh kos-linux-6.1.y-rockchip.tar.gz
md5sum kos-linux-6.1.y-rockchip.tar.gz
tar -xf kos-linux-6.1.y-rockchip.tar.gz
du -sh kos

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/kernel-devel-linux-6.1.y-rockchip.tar.gz
ls -alh kernel-devel-linux-6.1.y-rockchip.tar.gz
md5sum kernel-devel-linux-6.1.y-rockchip.tar.gz
tar -xf kernel-devel-linux-6.1.y-rockchip.tar.gz
du -sh kernel-devel

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_linux-6.1.y-rockchip_kernel/kernel-headers-linux-6.1.y-rockchip.tar.gz
ls -alh kernel-headers-linux-6.1.y-rockchip.tar.gz
md5sum kernel-headers-linux-6.1.y-rockchip.tar.gz
tar -xf kernel-headers-linux-6.1.y-rockchip.tar.gz
...
if [ -d kos/lib/modules ]; then
  ...
  if [ "$AVAIL" -ge "$REQ" ]; then
    ...
    # current in ${WORKDIR}/ophub_linux-6.1.y-rockchip
...
cp -f Image-linux-6.1.y-rockchip-kdev /mnt/vmlinuz-linux-6.1.y-rockchip-kdev
cp -f config-linux-6.1.y-rockchip-kdev /mnt/config-linux-6.1.y-rockchip-kdev
cp -f System.map-linux-6.1.y-rockchip-kdev /mnt/System.map-linux-6.1.y-rockchip-kdev
touch /mnt/initrd.img-linux-6.1.y-rockchip-kdev
...
label normal
	menu label Linux kernel linux-6.1.y-rockchip-kdev
	linux vmlinuz-linux-6.1.y-rockchip-kdev
	initrd initrd.img-linux-6.1.y-rockchip-kdev
...
label single
	menu label Linux kernel linux-6.1.y-rockchip-kdev (rescue target)
	linux vmlinuz-linux-6.1.y-rockchip-kdev
	initrd initrd.img-linux-6.1.y-rockchip-kdev
	fdt /dtb/rk3588-bdy-g98.dtb
