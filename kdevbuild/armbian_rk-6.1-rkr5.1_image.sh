...
mkdir -p ophub_rk-6.1-rkr5.1
cd ophub_rk-6.1-rkr5.1

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/armbian_rk-6.1-rkr5.1_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/armbian_rk-6.1-rkr5.1_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/armbian_rk-6.1-rkr5.1_kernel/config-6.1-kdev
ls -alh config-6.1-kdev
md5sum config-6.1-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/armbian_rk-6.1-rkr5.1_kernel/System.map-6.1-kdev
ls -alh System.map-6.1-kdev
md5sum System.map-6.1-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/armbian_rk-6.1-rkr5.1_kernel/rk3588-bdy-g98.dtb
ls -alh rk3588-bdy-g98.dtb
md5sum rk3588-bdy-g98.dtb

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/armbian_rk-6.1-rkr5.1_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
