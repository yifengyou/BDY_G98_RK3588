...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/rockchip-linux_develop-6.6_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/rockchip-linux_develop-6.6_kernel/config-6.6-kdev
ls -alh config-6.6-kdev
md5sum config-6.6-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/rockchip-linux_develop-6.6_kernel/System.map-6.6-kdev
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/rockchip-linux_develop-6.6_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
