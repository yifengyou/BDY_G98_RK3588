...
如果没有拔掉公头USB，无法进入web刷机，而是进入loader模式
...
* 如果在4步骤接入的是LAN口，浏览器中打开地址是<http://192.168.98.1>
* 如果在4步骤接入的是WAN口，在路由器上查看ip后，打开对应地址即可
