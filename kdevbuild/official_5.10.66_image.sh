...
export BUILD_TAG="BDY_G98_5.10.66_${set_rootfs}"
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/official_5.10.66_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/official_5.10.66_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/official_5.10.66_kernel/config-5.10.66-kdev
ls -alh config-5.10.66-kdev
md5sum config-5.10.66-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/official_5.10.66_kernel/System.map-5.10.66-kdev
ls -alh System.map-5.10.66-kdev
md5sum System.map-5.10.66-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/official_5.10.66_kernel/rk3588-bdy-g98.dtb
ls -alh rk3588-bdy-g98.dtb
md5sum rk3588-bdy-g98.dtb

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/official_5.10.66_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
