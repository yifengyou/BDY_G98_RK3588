...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/torvalds_linux_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/torvalds_linux_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/torvalds_linux_kernel/config-7.0-kdev
ls -alh config-7.0-kdev
md5sum config-7.0-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/torvalds_linux_kernel/System.map-7.0-kdev
ls -alh System.map-7.0-kdev
md5sum System.map-7.0-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/torvalds_linux_kernel/rk3588-bdy-g98.dtb
ls -alh rk3588-bdy-g98.dtb
md5sum rk3588-bdy-g98.dtb

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/torvalds_linux_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
