...
export BUILD_TAG="BDY_G98_6.1.y_${set_rootfs}"
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.1.y_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.1.y_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.1.y_kernel/config-6.1.y-kdev
ls -alh config-6.1.y-kdev
md5sum config-6.1.y-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.1.y_kernel/System.map-6.1.y-kdev
ls -alh System.map-6.1.y-kdev
md5sum System.map-6.1.y-kdev

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.1.y_kernel/rk3588-bdy-g98.dtb
ls -alh rk3588-bdy-g98.dtb
md5sum rk3588-bdy-g98.dtb

wget -c https://github.com/yifengyou/BDY_G98_RK3588/releases/download/ophub_6.1.y_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
...
cp -f Image /mnt/vmlinuz-6.1.y-kdev
cp -f config-6.1.y-kdev /mnt/config-6.1.y-kdev
cp -f System.map-6.1.y-kdev /mnt/System.map-6.1.y-kdev
...
label l0
	menu label Linux kernel 6.1.y-kdev
	linux vmlinuz-6.1.y-kdev
	initrd initrd.img-6.1.y-kdev
...
label l0r
	menu label Linux kernel 6.1.y-kdev (rescue target)
	linux vmlinuz-6.1.y-kdev
	initrd initrd.img-6.1.y-kdev
	fdt /dtb/rk3588-bdy-g98.dtb
